...
\begin{figure}[H]
  \centering
  \includegraphics[width=70mm]{images/research_methodology.jpg}
...
\\\indent The book also answers the question : \enquote{Why should we choose wiki ?}. It suggests that documenting software architecture on a wiki platform ha several advantages :
\begin{itemize}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{images/ALM_process_roles.jpg}
